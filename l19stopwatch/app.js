...
// 	clearInterval(setinvdisplay); //for clicking start btn multi times
...
function showdisplay(){
	...
	if(idx === 0){
			...
			getdisplay[idx].innerHTML = `${h} : ${m} : ${s} :${ms}`; //be careful must have idx 
	...
	if(milliseconds > 99){
		milliseconds = 0;
		seconds++;
		getdlpmlsec.innerHTML = "0" + 0; //for 100
